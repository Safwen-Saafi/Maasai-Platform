                        ...
                        markers.map(({ name, coordinates, timezone, open, close }) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <text textAnchor='middle' y={-15} className={styles.text}>
                                        {name}
                                    </text>
                                    {hoveredMarker === name && (
                                        <foreignObject 
                    ...
                    markers.map(({ name, timezone }) => {
                        ...
                        return (
                            <div key={name} className={styles.countdownBox}>
                                ...
                                <div>{countdown ? formatCountdown(countdown.countdown) : "Loading..."}</div>
                                <div className={statusClass}>{countdown ? `Countdown ${countdown.status}` : ""}</div>
                            </div>
                        );
                    })
                }
